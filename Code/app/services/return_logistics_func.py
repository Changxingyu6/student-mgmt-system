...
def return_logistics_insert_func(returnlogisticsdata, db):
    ...
    return return_logistics_dao.return_logistics_insert_dao(data, db)

# 更新方法
def return_logistics_update_func(returnlogisticsdata, db):
    data = returnlogisticsdata.model_dump()
    return return_logistics_dao.return_logistics_update_dao(data, db)

# 删除方法
def return_logistics_delete_func(return_logistics_id, db):
    return return_logistics_dao.return_logistics_delete_dao(return_logistics_id, db)
