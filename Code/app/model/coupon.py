...
class Coupon(Base):
    ...
    coupons_no = Column(String, nullable=False, unique=True, comment='券编号')
    coupons_name = Column(String, nullable=False, comment='券名称')
...
class UserCoupon(Base):
    ...
    coupon_no = Column(String, nullable=False, comment='优惠券编号')
...
class Activities(Base):
    ...
    id = Column(VARCHAR(50), primary_key=True, comment='主键ID')
    activities_name = Column(String, nullable=False, comment='活动名称')
    activities_type = Column(String, nullable=False, comment='1满减,2折扣')
    face_value = Column(DECIMAL(10, 2), nullable=False, default=1.00, comment='面额/折扣值')
    min_spend = Column(DECIMAL(10, 2), nullable=False, default=0.00, comment='满减门槛')
