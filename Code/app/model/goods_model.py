...
from sqlalchemy import Column, String, Integer, Float, DateTime, Text, ForeignKey, Index, VARCHAR
...
class Goods(Base):
    ...
    # 关联库存表
    stock = relationship("GoodsStock", back_populates="goods", uselist=False, cascade="all, delete-orphan")
...
class GoodsStock(Base):
    ...
    goods_id = Column(String(50), ForeignKey("goods.id"), nullable=False, unique=True, comment="商品ID")
    ...
    goods = relationship("Goods", back_populates="stock")
